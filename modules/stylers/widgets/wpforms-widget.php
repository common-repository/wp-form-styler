...
class WPForms_Widget extends Widget_Base {

	public function get_name() {
		return 'wpforms-widget';
	}

	public function get_title() {
		return __( 'WPForms', 'wp-form-styler' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'select_form',
			[
				'label' => __( 'Availabe Forms', 'wp-form-styler' ),
				'type' => Controls_Manager::SELECT,
				'default' => [],
				'options' => wpfs_wpforms_temp(),
				'description' => __( 'List of your available WPForms templates.', 'wp-form-styler' ),
			]
		);
	...
	protected function render() {
		...
		echo do_shortcode('[wpforms id="' . $selected_form . '"]');
